...
class Agent:
    ...
    def MAXQ_0(self, i, s, render):  # i is action number
        if self.done:
...
for j in range(episodes):
    print(f"{j}/{episodes}", end='\r')
    taxi.reset()
    taxi.MAXQ_0(10, env.s, (j == (episodes - 1)))      # start in root
...
print(counter/episodes%100, "percent successes")
